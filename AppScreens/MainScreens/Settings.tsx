...
{/* /'#191C26' ,#1E2230 */}
            ...
            <View style={{ flex: 6, backgroundColor: '#191C26' }}>
                ...
                <ScrollView showsVerticalScrollIndicator={false} style={{ width: '90%', height: 610, backgroundColor: '#1E2230', alignSelf: 'center', margin: 20, borderRadius: 10 }}>
                    ...
                    <CustomeNavigationComp LeftIcon={'paypal'} LeftIconColor={'#ffffff'} LeftIconSize={30} RightIcon={"chevron-right"} RightIconColor={"#ffffff"} RightIconSize={30} title={'Payment'} changeItem={false} />
